    ...
    <div className="px-[100px] mx-auto grid grid-cols-12 py-20">
      ...
      <div className="col-span-8 ml-10 px-10 py-5 bg-gray-300">
        <div className="">
          ...
          <div className="border-b border-red-500 py-3">
            <h1 className="text-xl">
              <span className="font-bold">Primary Number</span> :{" "}
              {details?.Phone?.Phone1}
            </h1>
          </div>
          <div className="border-b border-red-500 py-3">
            <h1 className="text-xl">
              <span className="font-bold">Extra Number</span> :{" "}
              {details?.Phone?.Phone2}
            </h1>
          </div>
          <div className="border-b border-red-500 py-3">
            <h1 className="text-xl">
              <span className="font-bold">Full Address</span> : {Address}
            </h1>
          </div>
          <div className="flex flex-row">
            <div className="basis-1/2 border-b border-red-500 py-3">
              <h1 className="text-xl">
                <span className="font-bold">Post Code</span> : {PostCode}
              </h1>
            </div>
            <div className="basis-1/2 border-b border-red-500 py-3">
              <h1 className="text-xl">
                <span className="font-bold">House Number</span> : {HouseNo}
              </h1>
            </div>
          </div>
          <div className="flex flex-row mt-5">
            <div className="basis-1/2">
              <button
                onClick={() => logout()}
                className="btn btn-primary btn-outline text-lg font-bold">
                Edit Details
              </button>
            </div>
            <div className="basis-1/2">
              <button
                onClick={() => logout()}
                className="btn btn-secondary btn-outline text-lg font-bold float-right">
                Log Out
              </button>
            </div>
          </div>
